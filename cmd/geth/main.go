...
var (
	...
	builderApiFlags = []cli.Flag{
		...
		utils.BuilderRelayEndpoint,
		utils.BuilderExposedAccessPoint,
		utils.BuilderMetricsEnabled,
		utils.BuilderMetricsReset,
		utils.BuilderRPBS,
		utils.BuilderBundlesEnabled,
		utils.BuilderBundlesReset,
		utils.BuilderBundlesMaxLifetime,
		utils.BuilderBundlesMaxFuture,
		utils.BuilderSubmissionEndWindow,
		utils.BuilderEngineRateLimit,
	}
